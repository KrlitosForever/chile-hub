...
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `fresh (0.37h / 72h)` | `open-attribution (Reproducción libre con citación (BCCh / INE))` | 375 | `Tier A/B` | `fecha, codigo_indicador` | `ok` |
