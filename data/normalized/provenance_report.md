...
- `generated_at_utc`: `2026-06-01T16:00:48.413368+00:00`
- `dataset_count`: `4`
- `live_count`: `4`
- `fallback_count`: `0`
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `regiones` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-01T15:59:50.538076+00:00` | `fresh (0.02h / 2160h)` | `open-attribution` |
| `provincias` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-01T15:59:50.538076+00:00` | `fresh (0.02h / 2160h)` | `open-attribution` |
| `comunas` | BCN ArcGIS | `live` | `bcn_arcgis` | `2026-06-01T15:59:50.538076+00:00` | `fresh (0.02h / 2160h)` | `open-attribution` |
| `indicadores` | Banco Central de Chile (via mindicador.cl) | `live` | `public_api` | `2026-06-01T15:38:37.668778+00:00` | `fresh (0.37h / 72h)` | `open-attribution` |
